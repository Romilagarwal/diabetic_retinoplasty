...
def create_detailed_architecture_diagram():
    ...
    components = [
        ...
        {"name": "Softmax\nOutput (5 classes)", "position": [0.9, 0.4, 0.15, 0.15], "color": "#87CEFA"}
    ]
    ...
    plt.title('Hybrid EfficientNet-B0 + Swin Transformer Architecture for DR Detection', fontsize=14)
    plt.text(0.5, 0.9, 'Feature Extraction', ha='center', fontsize=12)
    plt.text(0.7, 0.25, 'Classification', ha='center', fontsize=12)
